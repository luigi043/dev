...
namespace InsureX.Application.DTOs
{
    public class PolicyDto
    {
        ...
        public Guid AssetId { get; set; }            // Changed to Guid for consistency
    ...
    public class PolicySearchDto
    {
        ...
        public Guid? AssetId { get; set; }           // Changed to Guid
    ...
    public class ClaimDto
    {
        ...
        public Guid PolicyId { get; set; }           // Changed to Guid
        public string PolicyNumber { get; set; } = string.Empty;
   ...
   public class CreatePolicyDto
    ...
    {
        [Required]
        public Guid Id { get; set; }                 // Added ID for update
    }
}